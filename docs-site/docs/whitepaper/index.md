...
description: "Batho v1.3.2 Technical Whitepaper — Bidirectional AST Traversal & Hypergraph Orchestrator"
---

# Batho v1.3.2 Technical Whitepaper
...
flowchart TB
    ...
    subgraph Engine["Batho Core Engine"]
        ...
        CG["Code Graph<br/>(InMemoryGraph / ArrowGraph + SymbolIndex)"]
...
**Figure 1: Batho v1.3.2 System Architecture Overview** - High-level data flow from source inputs through the core engine to consumption interfaces.
...
|--------|-------|---------|
| Figure 1 | Batho v1.3.2 System Architecture Overview | Overview |
