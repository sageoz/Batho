...
📁 batho_core/
  ...
  📄 time_machine.py
    ...
    - diff_snapshots(a: dict[str, Any], b: dict[str, Any]) -> dict[str, Any] (function) [L114-131]
...
📁 batho_core/context/
  📄 c4_generator.py
    ...
    - __init__(self, ctn_dir: Path, index_id: str) -> Dict[str, Any] (method) [L23-35]
  ...
  📄 c4_llm_extensions.py
    ...
    - __init__(self, graph: Dict[str, Any], repomap: Dict[str, Any], 
                 index_metadata: Dict[str, Any]) -> Dict[str, str] (method) [L18-28]
  ...
  📄 c4_rules.py
    ...
    - __init__(self) -> List[ExternalSystemRule] (method) [L53-56]
  ...
  📄 stack_detector.py
    ...
    - _detect_java(root_path: Path) -> dict[str, Any] | None (function) [L515-551]
