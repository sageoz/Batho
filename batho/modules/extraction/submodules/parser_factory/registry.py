...
the leading dot) to the corresponding :class:`~batho.modules.extraction.extractor.ASTExtractor`
...
`batho.modules.extraction.submodules.parser_factory` package. New languages can be added by
...
def get_extractor(extension: str) -> ASTExtractor | None:
    """
    Return a cached :class:`~batho.modules.extraction.extractor.ASTExtractor` instance
