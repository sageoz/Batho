...
from batho.modules.compression import load_effective_rules
from batho.modules.compression.rules import apply_rule_plugins, validate_plugin_file
from batho.modules.compression.testing import (
    FixtureError,
    FixtureReport,
...
def cmd_plugins_trace(args: argparse.Namespace) -> int:
    ...
    try:
        from batho.modules.storage.cache.graph_cache import load_cached_graph
