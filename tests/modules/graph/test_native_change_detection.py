...
from batho.modules.storage.sqlite_registry.engine import BathoDatabase, get_database, artifact_filename, _DB_CACHE, _DB_CACHE_LOCK
...
class TestMigrationFromGitMode:
    ...
    def test_patchmode_import_fails(self):
        ...
        with pytest.raises(ImportError):
            from batho.modules import PatchMode
