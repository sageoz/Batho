...
class TestMinification:
    ...
    def test_entity_round_trip(self):
        from batho.storage.engine import _minify_entity, _expand_entity
    ...
    def test_relationship_round_trip(self):
        from batho.storage.engine import _minify_relationship, _expand_relationship
    ...
    def test_graph_payload_round_trip(self):
        from batho.storage.engine import _minify_graph_payload, _expand_graph_payload
