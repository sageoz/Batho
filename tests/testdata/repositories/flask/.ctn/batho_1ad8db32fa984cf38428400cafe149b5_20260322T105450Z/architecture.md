📁 (root)/
  📄 .pre-commit-config.yaml
    - document (document) [L1-38]
    - root (section) [L1-1]
    - root.ci (section) [L1-1]
    - root.ci.autoupdate_branch (setting) [L1-1]
    - root.ci.autoupdate_schedule (setting) [L1-1]
    - root.repos (section) [L1-1]
    - root.repos.[0] (section) [L1-1]
    - root.repos.[0].repo (setting) [L1-1]
    - root.repos.[0].rev (setting) [L1-1]
    - root.repos.[0].hooks (section) [L1-1]
    - root.repos.[0].hooks.[0] (section) [L1-1]
    - root.repos.[0].hooks.[0].id (setting) [L1-1]
    - root.repos.[0].hooks.[0].args (section) [L1-1]
    - root.repos.[0].hooks.[0].args.[0] (setting) [L1-1]
    - root.repos.[1] (section) [L1-1]
    - root.repos.[1].repo (setting) [L1-1]
    - root.repos.[1].rev (setting) [L1-1]
    - root.repos.[1].hooks (section) [L1-1]
    - root.repos.[1].hooks.[0] (section) [L1-1]
    - root.repos.[1].hooks.[0].id (setting) [L1-1]
    - root.repos.[1].hooks.[0].name (setting) [L1-1]
    - root.repos.[1].hooks.[0].files (setting) [L1-1]
    - root.repos.[1].hooks.[0].args (section) [L1-1]
    - root.repos.[1].hooks.[0].args.[0] (setting) [L1-1]
    - root.repos.[1].hooks.[0].args.[1] (setting) [L1-1]
    - root.repos.[2] (section) [L1-1]
    - root.repos.[2].repo (setting) [L1-1]
    - root.repos.[2].rev (setting) [L1-1]
    - root.repos.[2].hooks (section) [L1-1]
    - root.repos.[2].hooks.[0] (section) [L1-1]
    - root.repos.[2].hooks.[0].id (setting) [L1-1]
    - root.repos.[3] (section) [L1-1]
    - root.repos.[3].repo (setting) [L1-1]
    - root.repos.[3].rev (setting) [L1-1]
    - root.repos.[3].hooks (section) [L1-1]
    - root.repos.[3].hooks.[0] (section) [L1-1]
    - root.repos.[3].hooks.[0].id (setting) [L1-1]
    - root.repos.[3].hooks.[0].additional_dependencies (section) [L1-1]
    - root.repos.[3].hooks.[0].additional_dependencies.[0] (setting) [L1-1]
    - root.repos.[3].hooks.[0].additional_dependencies.[1] (setting) [L1-1]
    - root.repos.[4] (section) [L1-1]
    - root.repos.[4].repo (setting) [L1-1]
    - root.repos.[4].rev (setting) [L1-1]
    - root.repos.[4].hooks (section) [L1-1]
    - root.repos.[4].hooks.[0] (section) [L1-1]
    - root.repos.[4].hooks.[0].id (setting) [L1-1]
    - root.repos.[5] (section) [L1-1]
    - root.repos.[5].repo (setting) [L1-1]
    - root.repos.[5].rev (setting) [L1-1]
    - root.repos.[5].hooks (section) [L1-1]
    - root.repos.[5].hooks.[0] (section) [L1-1]
    - root.repos.[5].hooks.[0].id (setting) [L1-1]
    - root.repos.[5].hooks.[1] (section) [L1-1]
    - root.repos.[5].hooks.[1].id (setting) [L1-1]
    - root.repos.[5].hooks.[2] (section) [L1-1]
    - root.repos.[5].hooks.[2].id (setting) [L1-1]
  📄 .readthedocs.yaml
    - document (document) [L1-14]
    - root (section) [L1-1]
    - root.version (setting) [L1-1]
    - root.build (section) [L1-1]
    - root.build.os (setting) [L1-1]
    - root.build.tools (section) [L1-1]
    - root.build.tools.python (setting) [L1-1]
    - root.python (section) [L1-1]
    - root.python.install (section) [L1-1]
    - root.python.install.[0] (section) [L1-1]
    - root.python.install.[0].requirements (setting) [L1-1]
    - root.python.install.[1] (section) [L1-1]
    - root.python.install.[1].method (setting) [L1-1]
    - root.python.install.[1].path (setting) [L1-1]
    - root.sphinx (section) [L1-1]
    - root.sphinx.builder (setting) [L1-1]
    - root.sphinx.fail_on_warning (setting) [L1-1]
  📄 CODE_OF_CONDUCT.md
    - document (document) [L1-77]
    - header_1_Contributor Covenant Code of Conduct (element) [L1-1]
    - header_2_Our Pledge (element) [L3-3]
    - header_2_Our Standards (element) [L12-12]
    - list_item_unordered (element) [L16-16]
    - list_item_unordered (element) [L18-18]
    - list_item_unordered (element) [L19-19]
    - list_item_unordered (element) [L20-20]
    - list_item_unordered (element) [L21-21]
    - list_item_unordered (element) [L24-24]
    - list_item_unordered (element) [L27-27]
    - list_item_unordered (element) [L28-28]
    - list_item_unordered (element) [L29-29]
    - list_item_unordered (element) [L31-31]
    - header_2_Our Responsibilities (element) [L34-34]
    - header_2_Scope (element) [L46-46]
    - header_2_Enforcement (element) [L55-55]
    - header_2_Attribution (element) [L68-68]
  📄 metadata.py
  ...
  📄 pyproject.toml
    - document (document) [L1-109]
    - root (section) [L1-1]
    - root.project (section) [L1-1]
    - root.project.name (setting) [L1-1]
    - root.project.description (setting) [L1-1]
    - root.project.readme (setting) [L1-1]
    - root.project.license (section) [L1-1]
    - root.project.license.file (setting) [L1-1]
    - root.project.maintainers (section) [L1-1]
    - root.project.maintainers.[0] (section) [L1-1]
    - root.project.maintainers.[0].name (setting) [L1-1]
    - root.project.maintainers.[0].email (setting) [L1-1]
    - root.project.classifiers (section) [L1-1]
    - root.project.classifiers.[0] (setting) [L1-1]
    - root.project.classifiers.[1] (setting) [L1-1]
    - root.project.classifiers.[2] (setting) [L1-1]
    - root.project.classifiers.[3] (setting) [L1-1]
    - root.project.classifiers.[4] (setting) [L1-1]
    - root.project.classifiers.[5] (setting) [L1-1]
    - root.project.classifiers.[6] (setting) [L1-1]
    - root.project.classifiers.[7] (setting) [L1-1]
    - root.project.classifiers.[8] (setting) [L1-1]
    - root.project.classifiers.[9] (setting) [L1-1]
    - root.project.classifiers.[10] (setting) [L1-1]
    - root.project.requires-python (setting) [L1-1]
    - root.project.dependencies (section) [L1-1]
    - root.project.dependencies.[0] (setting) [L1-1]
    - root.project.dependencies.[1] (setting) [L1-1]
    - root.project.dependencies.[2] (setting) [L1-1]
    - root.project.dependencies.[3] (setting) [L1-1]
    - root.project.dependencies.[4] (setting) [L1-1]
    - root.project.dependencies.[5] (setting) [L1-1]
    - root.project.dynamic (section) [L1-1]
    - root.project.dynamic.[0] (setting) [L1-1]
    - root.project.urls (section) [L1-1]
    - root.project.urls.Donate (setting) [L1-1]
    - root.project.urls.Documentation (setting) [L1-1]
    - root.project.urls.Changes (setting) [L1-1]
    - root.project.urls.Source Code (setting) [L1-1]
    - root.project.urls.Issue Tracker (setting) [L1-1]
    - root.project.urls.Chat (setting) [L1-1]
    - root.project.optional-dependencies (section) [L1-1]
    - root.project.optional-dependencies.async (section) [L1-1]
    - root.project.optional-dependencies.async.[0] (setting) [L1-1]
    - root.project.optional-dependencies.dotenv (section) [L1-1]
    - root.project.optional-dependencies.dotenv.[0] (setting) [L1-1]
    - root.project.scripts (section) [L1-1]
    - root.project.scripts.flask (setting) [L1-1]
    - root.build-system (section) [L1-1]
    - root.build-system.requires (section) [L1-1]
    - root.build-system.requires.[0] (setting) [L1-1]
    - root.build-system.build-backend (setting) [L1-1]
    - root.tool (section) [L1-1]
    - root.tool.flit (section) [L1-1]
    - root.tool.flit.module (section) [L1-1]
    - root.tool.flit.module.name (setting) [L1-1]
    - root.tool.flit.sdist (section) [L1-1]
    - root.tool.flit.sdist.include (section) [L1-1]
    - root.tool.flit.sdist.include.[0] (setting) [L1-1]
    - root.tool.flit.sdist.include.[1] (setting) [L1-1]
    - root.tool.flit.sdist.include.[2] (setting) [L1-1]
    - root.tool.flit.sdist.include.[3] (setting) [L1-1]
    - root.tool.flit.sdist.include.[4] (setting) [L1-1]
    - root.tool.flit.sdist.include.[5] (setting) [L1-1]
    - root.tool.flit.sdist.include.[6] (setting) [L1-1]
    - root.tool.flit.sdist.exclude (section) [L1-1]
    - root.tool.flit.sdist.exclude.[0] (setting) [L1-1]
    - root.tool.pytest (section) [L1-1]
    - root.tool.pytest.ini_options (section) [L1-1]
    - root.tool.pytest.ini_options.testpaths (section) [L1-1]
    - root.tool.pytest.ini_options.testpaths.[0] (setting) [L1-1]
    - root.tool.pytest.ini_options.filterwarnings (section) [L1-1]
    - root.tool.pytest.ini_options.filterwarnings.[0] (setting) [L1-1]
    - root.tool.coverage (section) [L1-1]
    - root.tool.coverage.run (section) [L1-1]
    - root.tool.coverage.run.branch (setting) [L1-1]
    - root.tool.coverage.run.source (section) [L1-1]
    - root.tool.coverage.run.source.[0] (setting) [L1-1]
    - root.tool.coverage.run.source.[1] (setting) [L1-1]
    - root.tool.coverage.paths (section) [L1-1]
    - root.tool.coverage.paths.source (section) [L1-1]
    - root.tool.coverage.paths.source.[0] (setting) [L1-1]
    - root.tool.coverage.paths.source.[1] (setting) [L1-1]
    - root.tool.mypy (section) [L1-1]
    - root.tool.mypy.python_version (setting) [L1-1]
    - root.tool.mypy.files (section) [L1-1]
    - root.tool.mypy.files.[0] (setting) [L1-1]
    - root.tool.mypy.show_error_codes (setting) [L1-1]
    - root.tool.mypy.pretty (setting) [L1-1]
    - root.tool.mypy.allow_redefinition (setting) [L1-1]
    - root.tool.mypy.disallow_subclassing_any (setting) [L1-1]
    - root.tool.mypy.no_implicit_optional (setting) [L1-1]
    - root.tool.mypy.local_partial_types (setting) [L1-1]
    - root.tool.mypy.strict_equality (setting) [L1-1]
    - root.tool.mypy.warn_redundant_casts (setting) [L1-1]
    - root.tool.mypy.warn_unused_configs (setting) [L1-1]
    - root.tool.mypy.warn_unused_ignores (setting) [L1-1]
    - root.tool.mypy.overrides (section) [L1-1]
    - root.tool.mypy.overrides.[0] (section) [L1-1]
    - root.tool.mypy.overrides.[0].module (section) [L1-1]
    - root.tool.mypy.overrides.[0].module.[0] (setting) [L1-1]
    - root.tool.mypy.overrides.[0].module.[1] (setting) [L1-1]
    - root.tool.mypy.overrides.[0].module.[2] (setting) [L1-1]
    - root.tool.mypy.overrides.[0].module.[3] (setting) [L1-1]
    - root.tool.mypy.overrides.[0].ignore_missing_imports (setting) [L1-1]
  📄 repository_metadata.json
    - document (document) [L1-159]
    - root (section) [L1-1]
    - root.config_files (section) [L1-1]
    - root.config_files.[0] (setting) [L1-1]
    - root.config_files.[1] (setting) [L1-1]
    - root.config_files.[2] (setting) [L1-1]
    - root.config_files.[3] (setting) [L1-1]
    - root.config_files.[4] (setting) [L1-1]
    - root.directories (section) [L1-1]
    - root.directories.docs (setting) [L1-1]
    - root.directories.docs/_static (setting) [L1-1]
    - root.directories.docs/deploying (setting) [L1-1]
    - root.directories.docs/patterns (setting) [L1-1]
    - root.directories.docs/tutorial (setting) [L1-1]
    - root.directories.requirements (setting) [L1-1]
    - root.directories.src (setting) [L1-1]
    - root.directories.src/flask (setting) [L1-1]
    - root.directories.src/flask/json (setting) [L1-1]
    - root.documentation_files (section) [L1-1]
    - root.documentation_files.[0] (setting) [L1-1]
    - root.documentation_files.[1] (setting) [L1-1]
    - root.documentation_files.[2] (setting) [L1-1]
    - root.documentation_files.[3] (setting) [L1-1]
    - root.documentation_files.[4] (setting) [L1-1]
    - root.documentation_files.[5] (setting) [L1-1]
    - root.documentation_files.[6] (setting) [L1-1]
    - root.documentation_files.[7] (setting) [L1-1]
    - root.documentation_files.[8] (setting) [L1-1]
    - root.documentation_files.[9] (setting) [L1-1]
    - root.documentation_files.[10] (setting) [L1-1]
    - root.documentation_files.[11] (setting) [L1-1]
    - root.documentation_files.[12] (setting) [L1-1]
    - root.documentation_files.[13] (setting) [L1-1]
    - root.documentation_files.[14] (setting) [L1-1]
    - root.documentation_files.[15] (setting) [L1-1]
    - root.documentation_files.[16] (setting) [L1-1]
    - root.documentation_files.[17] (setting) [L1-1]
    - root.documentation_files.[18] (setting) [L1-1]
    - root.documentation_files.[19] (setting) [L1-1]
    - root.documentation_files.[20] (setting) [L1-1]
    - root.documentation_files.[21] (setting) [L1-1]
    - root.documentation_files.[22] (setting) [L1-1]
    - root.documentation_files.[23] (setting) [L1-1]
    - root.documentation_files.[24] (setting) [L1-1]
    - root.documentation_files.[25] (setting) [L1-1]
    - root.documentation_files.[26] (setting) [L1-1]
    - root.documentation_files.[27] (setting) [L1-1]
    - root.documentation_files.[28] (setting) [L1-1]
    - root.documentation_files.[29] (setting) [L1-1]
    - root.documentation_files.[30] (setting) [L1-1]
    - root.documentation_files.[31] (setting) [L1-1]
    - root.documentation_files.[32] (setting) [L1-1]
    - root.documentation_files.[33] (setting) [L1-1]
    - root.documentation_files.[34] (setting) [L1-1]
    - root.documentation_files.[35] (setting) [L1-1]
    - root.documentation_files.[36] (setting) [L1-1]
    - root.documentation_files.[37] (setting) [L1-1]
    - root.documentation_files.[38] (setting) [L1-1]
    - root.documentation_files.[39] (setting) [L1-1]
    - root.documentation_files.[40] (setting) [L1-1]
    - root.documentation_files.[41] (setting) [L1-1]
    - root.documentation_files.[42] (setting) [L1-1]
    - root.documentation_files.[43] (setting) [L1-1]
    - root.documentation_files.[44] (setting) [L1-1]
    - root.documentation_files.[45] (setting) [L1-1]
    - root.documentation_files.[46] (setting) [L1-1]
    - root.documentation_files.[47] (setting) [L1-1]
    - root.documentation_files.[48] (setting) [L1-1]
    - root.documentation_files.[49] (setting) [L1-1]
    - root.documentation_files.[50] (setting) [L1-1]
    - root.documentation_files.[51] (setting) [L1-1]
    - root.documentation_files.[52] (setting) [L1-1]
    - root.documentation_files.[53] (setting) [L1-1]
    - root.documentation_files.[54] (setting) [L1-1]
    - root.documentation_files.[55] (setting) [L1-1]
    - root.documentation_files.[56] (setting) [L1-1]
    - root.documentation_files.[57] (setting) [L1-1]
    - root.documentation_files.[58] (setting) [L1-1]
    - root.documentation_files.[59] (setting) [L1-1]
    - root.documentation_files.[60] (setting) [L1-1]
    - root.documentation_files.[61] (setting) [L1-1]
    - root.documentation_files.[62] (setting) [L1-1]
    - root.documentation_files.[63] (setting) [L1-1]
    - root.documentation_files.[64] (setting) [L1-1]
    - root.documentation_files.[65] (setting) [L1-1]
    - root.documentation_files.[66] (setting) [L1-1]
    - root.documentation_files.[67] (setting) [L1-1]
    - root.documentation_files.[68] (setting) [L1-1]
    - root.documentation_files.[69] (setting) [L1-1]
    - root.documentation_files.[70] (setting) [L1-1]
    - root.documentation_files.[71] (setting) [L1-1]
    - root.documentation_files.[72] (setting) [L1-1]
    - root.documentation_files.[73] (setting) [L1-1]
    - root.documentation_files.[74] (setting) [L1-1]
    - root.documentation_files.[75] (setting) [L1-1]
    - root.documentation_files.[76] (setting) [L1-1]
    - root.documentation_files.[77] (setting) [L1-1]
    - root.documentation_files.[78] (setting) [L1-1]
    - root.documentation_files.[79] (setting) [L1-1]
    - root.documentation_files.[80] (setting) [L1-1]
    - root.documentation_files.[81] (setting) [L1-1]
    - root.documentation_files.[82] (setting) [L1-1]
    - root.documentation_files.[83] (setting) [L1-1]
    - root.documentation_files.[84] (setting) [L1-1]
    - root.documentation_files.[85] (setting) [L1-1]
    - root.file_extensions (section) [L1-1]
    - root.file_extensions..bat (setting) [L1-1]
    - root.file_extensions..in (setting) [L1-1]
    - root.file_extensions..ini (setting) [L1-1]
    - root.file_extensions..json (setting) [L1-1]
    - root.file_extensions..md (setting) [L1-1]
    - root.file_extensions..png (setting) [L1-1]
    - root.file_extensions..py (setting) [L1-1]
    - root.file_extensions..rst (setting) [L1-1]
    - root.file_extensions..sh (setting) [L1-1]
    - root.file_extensions..toml (setting) [L1-1]
    - root.file_extensions..txt (setting) [L1-1]
    - root.file_extensions..typed (setting) [L1-1]
    - root.file_extensions..yaml (setting) [L1-1]
    - root.languages (section) [L1-1]
    - root.languages.documentation (setting) [L1-1]
    - root.languages.python (setting) [L1-1]
    - root.name (setting) [L1-1]
    - root.python_modules (section) [L1-1]
    - root.python_modules.[0] (setting) [L1-1]
    - root.python_modules.[1] (setting) [L1-1]
    - root.python_modules.[2] (setting) [L1-1]
    - root.python_modules.[3] (setting) [L1-1]
    - root.python_modules.[4] (setting) [L1-1]
    - root.python_modules.[5] (setting) [L1-1]
    - root.python_modules.[6] (setting) [L1-1]
    - root.python_modules.[7] (setting) [L1-1]
    - root.python_modules.[8] (setting) [L1-1]
    - root.python_modules.[9] (setting) [L1-1]
    - root.python_modules.[10] (setting) [L1-1]
    - root.python_modules.[11] (setting) [L1-1]
    - root.python_modules.[12] (setting) [L1-1]
    - root.python_modules.[13] (setting) [L1-1]
    - root.python_modules.[14] (setting) [L1-1]
    - root.python_modules.[15] (setting) [L1-1]
    - root.python_modules.[16] (setting) [L1-1]
    - root.python_modules.[17] (setting) [L1-1]
    - root.python_modules.[18] (setting) [L1-1]
    - root.python_modules.[19] (setting) [L1-1]
    - root.python_modules.[20] (setting) [L1-1]
    - root.python_modules.[21] (setting) [L1-1]
    - root.python_modules.[22] (setting) [L1-1]
    - root.test_files (section) [L1-1]
    - root.test_files.[0] (setting) [L1-1]
    - root.total_files (setting) [L1-1]
    - root.total_lines (setting) [L1-1]
    - root.version (setting) [L1-1]
📁 .devcontainer/
  📄 devcontainer.json
    - document (document) [L1-18]
    - root (section) [L1-1]
    - root.name (setting) [L1-1]
    - root.image (setting) [L1-1]
    - root.customizations (section) [L1-1]
    - root.customizations.vscode (section) [L1-1]
    - root.customizations.vscode.settings (section) [L1-1]
    - root.customizations.vscode.settings.python.defaultInterpreterPath (setting) [L1-1]
    - root.customizations.vscode.settings.python.terminal.activateEnvInCurrentTerminal (setting) [L1-1]
    - root.customizations.vscode.settings.python.terminal.launchArgs (section) [L1-1]
    - root.customizations.vscode.settings.python.terminal.launchArgs.[0] (setting) [L1-1]
    - root.customizations.vscode.settings.python.terminal.launchArgs.[1] (setting) [L1-1]
    - root.onCreateCommand (setting) [L1-1]
📁 docs/ (Documentation)
  📄 conf.py
    deps: docutils.nodes, docutils.parsers.rst.roles
    - github_link(name, rawtext, text, lineno, inliner, options=None, content=None) (function) [L67-92]
    - setup(app) (function) [L95-96]
📁 src/flask/
  📄 __init__.py
  ...
  📄 app.py
    ...
    ) -> HTTPException | ft.ResponseReturnValue (method) [L354-507]
  ...
  📄 cli.py
    ...
    - find_best_app(module) -> bool (function) [L33-83]
    - _called_with_wrong_args(f) -> bool (function) [L86-109]
    - find_app_by_string(module, app_name) -> bool (function) [L112-185]
    - prepare_import(path) -> bool (function) [L188-214]
    - locate_app(module_name, app_name, raise_if_not_found=True) -> bool (function) [L217-238]
    - get_version(ctx, param, value) -> bool (function) [L241-254]
    ...
    - with_appcontext(f) -> bool (function) [L338-360]
    - AppGroup (class) [L363-391]
    - command(self, *args, **kwargs) -> None (method) [L371-383]
    - decorator(f) -> bool (function) [L378-381]
  ...
  📄 scaffold.py
    - setupmethod(f: F) -> t.Any (function) [L45-52]
  ...
  📄 testing.py
    ...
    - _copy_environ(self, other) -> None (method) [L184-190]
    - _request_from_builder_args(self, args, kwargs) -> None (method) [L192-199]
    - open(
        self,
        *args: t.Any,
        buffered: bool = False,
