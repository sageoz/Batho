...
📁 src/flask/
  ...
  📄 cli.py
    ...
    - find_best_app(module) -> None (function) [L33-83]
    - _called_with_wrong_args(f) -> None (function) [L86-109]
    - find_app_by_string(module, app_name) -> None (function) [L112-185]
    - prepare_import(path) -> None (function) [L188-214]
    - locate_app(module_name, app_name, raise_if_not_found=True) -> None (function) [L217-238]
    - get_version(ctx, param, value) -> None (function) [L241-254]
    ...
    - with_appcontext(f) -> None (function) [L338-360]
    - AppGroup (class) [L363-391]
    - command(self, *args, **kwargs) -> None (method) [L371-383]
    - decorator(f) -> None (function) [L378-381]
  ...
  📄 helpers.py
    ...
    - stream_with_context() -> t.Generator (function) [L53-129]
