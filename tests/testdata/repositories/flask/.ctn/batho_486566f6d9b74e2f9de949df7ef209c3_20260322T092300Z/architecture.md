...
📁 src/flask/
  ...
  📄 cli.py
    deps: ast, click, click.core, code, cryptography, dotenv, functools, importlib, importlib.metadata, inspect, operator, os, platform, re, readline, rlcompleter, ssl, sys, traceback, werkzeug, werkzeug.serving, werkzeug.utils
    - if __name__ == "__main__":
  ...
  📄 scaffold.py
    ...
    - _find_package_path(import_name) -> T_error_handler (function) [L791-832]
    - find_package(import_name: str) -> T_error_handler (function) [L835-873]
  📄 sessions.py
