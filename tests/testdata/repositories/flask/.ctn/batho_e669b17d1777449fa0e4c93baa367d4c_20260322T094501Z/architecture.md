...
📁 src/flask/
  ...
  📄 cli.py
    ...
    - find_best_app(module) -> bool | None (function) [L33-83]
    - _called_with_wrong_args(f) -> bool | None (function) [L86-109]
    - find_app_by_string(module, app_name) -> bool | None (function) [L112-185]
    - prepare_import(path) -> bool | None (function) [L188-214]
    - locate_app(module_name, app_name, raise_if_not_found=True) -> bool | None (function) [L217-238]
    - get_version(ctx, param, value) -> bool | None (function) [L241-254]
    ...
    - with_appcontext(f) -> bool | None (function) [L338-360]
    - AppGroup (class) [L363-391]
    - command(self, *args, **kwargs) -> None (method) [L371-383]
    - decorator(f) -> bool | None (function) [L378-381]
    ...
    - _path_is_ancestor(path, other) -> bool | None (function) [L648-652]
    - load_dotenv(path: str | os.PathLike | None = None) -> bool (function) [L655-713]
    - show_server_banner(debug, app_import_path) -> bool | None (function) [L716-727]
    - CertParamType (class) [L730-773]
    - __init__(self) -> None (method) [L738-739]
    - convert(self, value, param, ctx) -> None (method) [L741-773]
    - _validate_key(ctx, param, value) -> bool | None (function) [L776-810]
  ...
  📄 ctx.py
    ...
    - copy_current_request_context(*args, **kwargs) -> t.Callable (function) [L148-186]
  ...
  📄 helpers.py
    ...
    - stream_with_context() -> t.Iterator[t.AnyStr] (function) [L53-129]
  ...
  📄 scaffold.py
    - setupmethod(self, *args: t.Any, **kwargs: t.Any) -> F (function) [L45-52]
  ...
  📄 testing.py
    ...
    - _copy_environ(self, other) -> str (method) [L184-190]
    - _request_from_builder_args(self, args, kwargs) -> str (method) [L192-199]
    - open(
        self,
        *args: t.Any,
        buffered: bool = False,
